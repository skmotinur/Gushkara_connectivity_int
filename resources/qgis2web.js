...
map.getView().fit([9760311.260637, 2689417.153947, 9772506.022713, 2696459.458690], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INTEGRATED CONNECTIVITY</h2>';
        return titleElement;
    })(),
